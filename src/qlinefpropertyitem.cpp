/*!
 * \file qlinefpropertyitem.cpp
 * \author Caleb Buahin <caleb.buahin@gmail.com>
 * \version 1.0.0
 * \description Implementation of QLineFPropertyItem.
 * \license
...
bool QLineFPropertyItem::hasChildren()
{
   if (!m_childrenSet)
   {
      ...
      QChildPointFPropertyItem* p2 = new QChildPointFPropertyItem(qvariant_cast<QVariant>(line.p2()), "P2", this);
