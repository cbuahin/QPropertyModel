/*!
 * \file qsizefpropertyitem.cpp
 * \author Caleb Buahin <caleb.buahin@gmail.com>
 * \version 1.0.0
 * \description Implementation of QSizeFPropertyItem.
 * \license
...
QSizeFPropertyItem::QSizeFPropertyItem(const QVariant& value, const QMetaProperty& metaProperty, QObjectClassPropertyItem * parent)
   : QVariantPropertyItem(value, metaProperty, parent), m_isSettingChildren(false)
{

}

QSizeFPropertyItem::~QSizeFPropertyItem()
{

}

QVariant QSizeFPropertyItem::data(int column, Qt::ItemDataRole  role) const
{
      ...
      case QPropertyItem::Value:
         switch (role)
         {
            ...
            case Qt::WhatsThisRole:
               {
                  QSizeF size = qvariant_cast<QSizeF>(m_metaProperty.read(m_parent->qObject()));
...
void QSizeFPropertyItem::setChildValues()
{
...
bool QSizeFPropertyItem::hasChildren()
{
   if (!m_childrenSet)
   {
      m_childrenSet = true;
...
Qt::ItemFlags QSizeFPropertyItem::flags() const
{
   Qt::ItemFlags  flags;
...
void QSizeFPropertyItem::onChildItemValueChanged(const QString& name, const QVariant& value)
{
   if (!m_isSettingChildren)
   {
      m_isSettingChildren = true;
