...
QVariantHashPropertyEditor::QVariantHashPropertyEditor(QWidget *parent)
	: QAbstractListPropertyEditor(parent)
{
	ui.label->setVisible(true);
	ui.lineEditKeyValue->setVisible(true);
	dialog->setWindowTitle("Hash Editor");
}

QVariantHashPropertyEditor::~QVariantHashPropertyEditor()
{

}

void QVariantHashPropertyEditor::setValue(const QVariant& value)
{
    map = qvariant_cast<QVariantHash>(value);
	setUpModel();
}

QVariant QVariantHashPropertyEditor::getValue() const
{
	return map;
}

void QVariantHashPropertyEditor::setUpModel() 
{	
...
void QVariantHashPropertyEditor::currentChanged(const QModelIndex & current, const QModelIndex & previous )
{
...
void QVariantHashPropertyEditor::addToList()
{
...
void QVariantHashPropertyEditor::removeFromList()
{
